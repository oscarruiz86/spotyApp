    ...
    if (peticion !== "error") {
        ...
        <img src="${peticion.images.find(imagen => imagen.height === 640)?.url}" alt="">
            ...
            const tracks = peticion.tracks.items.map((track,index)=>{
                ...
                <a data-playlist data-title="${index}. Got What I Got" data-artist="Jason Aldean" data-img="http://dmitryvolkov.me/demo/volna/img/covers/cover.svg" href="https://dmitryvolkov.me/demo/blast2.0/audio/12071151_epic-cinematic-trailer_by_audiopizza_preview.mp3" class="single-item__cover">
