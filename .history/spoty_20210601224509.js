...
const nuevosLanzamientos = async () => {
    ...
    if (peticion !== "error") {
        ...
        peticion.albums.items.map((cover)=>{
            console.log(cover)
            ...
            <div class="album">
                ...
                <div class="album__title">
                    ...
                    <span><a href="http://dmitryvolkov.me/demo/volna/artist.html">VIZE</a> & 
                    <a href="http://dmitryvolkov.me/demo/volna/artist.html">Alan Walker</a> & 
                    <a href="http://dmitryvolkov.me/demo/volna/artist.html">Leony</a></span>
                </div>
            </div>
        </div>`
        })
